...
def select_file_and_generate_email():
    global email_details  # Make email details accessible to copy functions
...
button_copy_subject.pack(side=tk.LEFT, padx=10)
...
text_result = tk.Text(root, height=30, width=80)
